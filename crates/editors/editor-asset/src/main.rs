//! Standalone launcher for the Asset Editor.
//! Compile with: `cargo run -p editor-asset --features standalone`
...
fn main() -> eframe::Result<()> {
    eframe::run_native(
        "Asset Editor — NovaForge Workspace",
        eframe::NativeOptions {
            viewport: egui::ViewportBuilder::default().with_inner_size([1024.0, 768.0]),
            ..Default::default()
        },
        Box::new(|_cc| Ok(Box::new(StandaloneApp::new(AssetEditor::new())))),
    )
}
