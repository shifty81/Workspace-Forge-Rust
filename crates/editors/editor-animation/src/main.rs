//! Standalone launcher for the Animation Editor.
//! Compile with: `cargo run -p editor-animation --features standalone`
...
fn main() -> eframe::Result<()> {
    eframe::run_native(
        "Animation Editor — NovaForge Workspace",
        eframe::NativeOptions {
            viewport: egui::ViewportBuilder::default().with_inner_size([1280.0, 600.0]),
            ..Default::default()
        },
        Box::new(|_cc| Ok(Box::new(StandaloneApp::new(AnimationEditor::default())))),
    )
}
